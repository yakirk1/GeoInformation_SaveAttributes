...
class SaveAttributes:
    ...
    def initGui(self):
        ...
        self.add_action(
            icon_path,
            text=self.tr(u'Save Attributes as TXT'),
            callback=self.run,
                ...
                with open(filename, 'w') as output_file:
                    ...
                    if selectedLayerIndex != -1:
                        ...
                        if hasattr(selectedLayer, 'fields'):
                            ...
                            self.iface.messageBar().pushMessage("Failure,please select VECTOR layer and try again.")
                    else:
                        self.iface.messageBar().pushMessage("Please add at least one vector layer to save and try again.")
            else:
                self.iface.messageBar().pushMessage("Please choose a TEXT file as an output file and try again.")